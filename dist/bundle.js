...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
var Todos_1 = __webpack_require__(/*! ./Todos */ "./src/components/Todos.tsx");
var TodoForm_1 = __webpack_require__(/*! ./TodoForm */ "./src/components/TodoForm.tsx");
...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.addTodo = function (e) {
        this.setState({
            todos: this.state.todos.concat([e])
        });
    };
    App.prototype.toggleStatus = function (e) {
        this.setState({
            todos: this.state.todos.slice(0, e.id).concat([
                e
    ...
    App.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(TodoForm_1.default, { addTodo: this.addTodo }),
            React.createElement(Todos_1.default, { todos: this.state.todos, toggleStatus: this.toggleStatus })));
    };
    return App;
}(React.Component));
exports.default = App;
...
var Todo = /** @class */ (function (_super) {
    ...
    Todo.prototype.handleClick = function () {
    ...
    Todo.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("input", { type: "checkbox", checked: todo.completed, onClick: this.handleClick, readOnly: true }),
            React.createElement("span", { className: todo.completed ? "complete" : "" }, todo.text)));
    };
    return Todo;
}(React.Component));
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
var TodoForm = /** @class */ (function (_super) {
    ...
    TodoForm.prototype.handleChange = function (e) {
        this.setState({
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
var Todo_1 = __webpack_require__(/*! ./Todo */ "./src/components/Todo.tsx");
var Todos = function (_a) {
    var todos = _a.todos, toggleStatus = _a.toggleStatus;
    return (React.createElement(React.Fragment, null, ["Todo", "Doing", "Done"].map(function (status) { return (React.createElement("div", { className: status.toLowerCase(), key: status }, todos
        .filter(function (todo) { return todo.status === status; })
        .map(function (todo) { return (React.createElement(Todo_1.default, { key: todo.id, todo: todo, toggleStatus: toggleStatus })); }))); })));
};
